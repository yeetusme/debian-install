...
sudo apt install -y p7zip-gui.x86_64 keepassxc vim htop gparted texlive-full VirtualBox firefox openbox obconf lxappearance lxpanel mpv thunar transmission
